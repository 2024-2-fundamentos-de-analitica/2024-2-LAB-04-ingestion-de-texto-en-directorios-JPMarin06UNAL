...
def extract_file():
    ...
    with zipfile.ZipFile(zip_path, 'r') as zip_refer:
        zip_refer.extractall()

    print("File extracted correctly in the folder 'input'.")
...
def verify_structure():
    ...
    if not os.path.exists(base_path):
        ...
        print("Error: The folder input does not exist after extraction.")
        return False
    ...
    for dataset in ["train", "test"]:
        ...
        if not os.path.exists(dataset_path):
            print(f"Error: The folder '{dataset}' does not exist in 'input'.")
            return False
        
        for sentiment in ["positive", "negative", "neutral"]:
            sentiment_path = os.path.join(dataset_path, sentiment)
            if not os.path.exists(sentiment_path):
                print(f"Warning: The folder '{sentiment}' does not exist in '{dataset}'.")
    return True
...
def procesar_datos():
    ...
    print("CSV files generated correctly.")
